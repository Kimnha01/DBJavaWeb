...
public class SearchAccountServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String accEmail = request.getParameter("txtemail");
            AccountDAO d = new AccountDAO();
            ArrayList<Account> list = d.searchAccount(accEmail);
            if (list.isEmpty()) {
                out.print("<h2>Not found</h2>");
                out.print("<p><a href='ManageAccountServlet'>Search again</a></p>");
            } else {
                out.print("<table>");
